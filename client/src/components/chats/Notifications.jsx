...
const Notification = () => {
    ...
    return (<div className="notifcations">
        <div className="notifications-icon" onClick={() => setIsOpen(!isOpen)}>
            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="white" className="bi bi-bell-fill" viewBox="0 0 16 16">
        ...
        {isOpen ? <div className="notifications-box">
            ...
            {modifiedNotifications && modifiedNotifications.map((n, index) => {
                ...
                >
                    ...
                    <span className="notifications-time">{moment(n.date).calendar()}</span>
                </div>
            })}
        </div> : null}
